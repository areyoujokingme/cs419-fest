...
<html>
    ...
    <body data-spy="scroll" data-target=".dropdown">
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                <form class="navbar-form" action="admin.php" method="GET" enctype="multipart/form-data">
                    ...
                    if ($_SESSION['logged_in_inventory_app_cs419'] == 1) {
                        ...
                        if ((!empty($_GET["search_query"]))) {
                            ...
                            if (!$stmt->execute()) {
                                ...
                                while ($stmt->fetch()) {
                                    echo "<tr><td style='padding-left: 10%'><button class='barcodeButton' name='barcodeID' value='" . $barcodeID . "' type='submit'><a>" . $i . "</a></button></td><td>" . $itemname . "</td></tr>\n";
                                    $i++;
                                }
                                echo "</table></form>";
                                if ($rowcount == 0) {
